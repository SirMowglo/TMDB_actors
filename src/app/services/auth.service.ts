...
export class AuthService {
  ...
  createSession(sessionDto: CreateSessionDto): Observable<CreateSessionResponse>{
    return this.http.post<CreateSessionResponse>(`${environment.base_url}/authentication/session/new?api_key=${environment.api_key}`,sessionDto);
  }
